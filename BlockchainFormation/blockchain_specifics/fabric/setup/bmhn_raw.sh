...
# declare -a BATCHTIMEOUTS=substitute_enum_batch_timeouts
...
for CHANNEL_NAME in ${CHANNELS[@]}; do
    ...
    # sed -i -e 's/BatchTimeout: 0.5s/BatchTimeout: 0.3s/g' /data/fabric-samples/Build-Multi-Host-Network-Hyperledger/configtx.yaml
done
