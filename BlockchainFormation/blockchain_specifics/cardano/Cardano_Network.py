...
class Cardano_Network:

    @staticmethod
    def shutdown(node_handler):
        """
        runs the Cardano specific shutdown operations (e.g. pulling the associated logs from the VMs)
        :return:
        """
    ...
    def startup(node_handler):
        """
        Runs the Cardano specific startup script
        :return:
        """
    ...
    def restart(node_handler):
        """
        Runs the Cardano specific restart script
        :return:
        """
